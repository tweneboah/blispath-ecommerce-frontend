 ...
 */ !(function (t) {
  ...
  function (t, e, n) {
    ...
    window.tram = (function (t) {
      ...
      if (W.transition) {
        var D = W.timing.dom;
        if (((A.style[D] = d['ease-in-back'][0]), !A.style[D]))
        ...
        q = l(function (e) {
          function n() {
            var t,
              ...
              i,
              r = u.length;
            if (r) for (z(n), e = M(), t = r; t--; ) (i = u[t]) && i.render(e);
          }
    ...
    i.define(
      ...
      (t.exports = function (t, e) {
        ...
        function x(e, n) {
          ...
          l.show(), S(e, n), a.css('display', ''), l.css('display', '');
        }
        function k(t) {
          var e = { crossOver: 0 };
        ...
        function I(n) {
          return function (r, a) {
            ...
            if (s && 'setting' === r.type) {
              ...
              if ((k(n), z(n), null == a.select)) return;
              !(function (n, i) {
                var r = null;
                i === n.slides.length && (w(), z(n)),
