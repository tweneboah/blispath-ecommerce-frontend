          ...
          <ul class='mx-auto space-y-16 sm:grid sm:grid-cols-2 sm:gap-16 sm:space-y-0 lg:grid-cols-3 lg:max-w-5xl'>
              ...
              <div class='space-y-6'>
                ...
                <div class='space-y-2'>
                  <div class='text-lg leading-6 font-medium space-y-1'>
                    <h3>Ofori Charles</h3>
                    <p class='text-indigo-600'>Chief Servant</p>
                  </div>
            ...
            <li>
              <div class='space-y-6'>
                ...
                <div class='space-y-2'>
                  <div class='text-lg leading-6 font-medium space-y-1'>
                    <h3>Taky Kwabena Nisah</h3>
                    <p class='text-indigo-600'>Operations Manager</p>
                  </div>
                </div>
              </div>
            </li>
            ...
            <li>
              <div class='space-y-6'>
                ...
                <div class='space-y-2'>
                  <div class='text-lg leading-6 font-medium space-y-1'>
                    <h3>Rhoda Anane</h3>
                    <p class='text-indigo-600'>Customer Experience</p>
                  </div>
                </div>
              </div>
            </li>
