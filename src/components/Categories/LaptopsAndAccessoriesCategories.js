...
const LaptopsAndAccessoriesCategories = () => {
  ...
  const laptopsAndAccessories =
    products &&
    products.filter(product => product.category === 'Laptops and Accessories');
        ...
        <div class='relative max-w-7xl mx-auto'>
          <div class='text-center'>
            <h2 class='text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl'>
              Laptops and Accessories - ({laptopsAndAccessories?.length})
            </h2>
            <p class='mt-3 max-w-2xl mx-auto text-xl pb-6  text-gray-500 sm:mt-4'>
              Our latest Laptops and Accessories collection
            </p>
            {/* Search input */}
          ...
          <div className='text-2xl text-center text-red-800 pt-4'>
            {laptopsAndAccessories?.length === 0 && !loading ? (
          ...
          <div class='mt-12   grid gap-3 lg:grid-cols-4 lg:max-w-none md:grid-cols-3 sm:grid-cols-2'>
            ...
            {laptopsAndAccessories?.map(product => {
...
export default LaptopsAndAccessoriesCategories;
