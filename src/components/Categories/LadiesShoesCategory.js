...
const LadiesShoesCategory = () => {
  ...
  const ladiesShoes =
    products && products.filter(product => product.category === 'Ladies Shoes');
        ...
        <div class='relative max-w-7xl mx-auto'>
          <div class='text-center'>
            <h2 class='text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl'>
              Ladies Shoes products - ({ladiesShoes?.length})
            </h2>
            <p class='mt-3 max-w-2xl mx-auto pb-6 pt-2 text-xl text-gray-500 sm:mt-4'>
              Our latest Ladies shoes collection
            </p>
            {/* Search input */}
...
export default LadiesShoesCategory;
