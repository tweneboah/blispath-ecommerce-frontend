...
const FashionCategories = () => {
  ...
  const fashions =
    products &&
    products.filter(product => product.category === 'Phone Accessories');
        ...
        <div class='relative max-w-7xl mx-auto'>
          <div class='text-center'>
            <h2 class='text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl'>
              Fashion products - ({fashions?.length})
            </h2>
            <p class='mt-3 max-w-2xl mx-auto text-xl pt-2 pb-6 text-gray-500 sm:mt-4'>
              Our latest fashions collection
            </p>
            {/* Search input */}
