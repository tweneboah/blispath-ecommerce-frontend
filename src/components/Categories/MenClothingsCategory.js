...
const MenClothingsCategory = () => {
  ...
  const ladiesShoes =
    products &&
    products.filter(product => product.category === 'Men Clothings');
...
export default MenClothingsCategory;
